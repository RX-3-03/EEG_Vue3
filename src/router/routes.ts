  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: '/meg/subject',
        components: {
          tabberRouter: () => import('@/views/meg/subject/tabbar.vue'),
          LayoutIcon1Router: () => import('@/views/meg/subject/LayoutIcon1.vue'),
          sliderRouter: () => import('@/views/meg/subject/slider.vue'),
          LayoutIcon2Router: () => import('@/views/meg/subject/LayoutIcon2.vue'),
      ...
      {
        path: '/meg/editMontage',
        components: {
          tabberRouter: () => import('@/views/meg/editMontage/tabbar.vue'),
          LayoutIcon1Router: () =>
            import('@/views/meg/editAmplifier/LayoutIcon1.vue'),
          sliderRouter: () => import('@/views/meg/editMontage/slider.vue'),
          LayoutIcon2Router: () =>
            import('@/views/meg/editAmplifier/LayoutIcon2.vue'),
          mainRouter: () => import('@/views/meg/editMontage/main.vue'),
        },
        meta: {
          title: '采集模板设置',
          hidden: false,
