...
const selectedValue5 = ref('5')
const selectedValue6 = ref('5')
watchEffect(() => {
  ...
  console.log('selectedValue4:', selectedValue4.value)
  console.log('selectedValue5:', selectedValue4.value)
  console.log('selectedValue6:', selectedValue4.value)
})
